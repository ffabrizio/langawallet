 ...
 * Amplify 1.1.2                                                                                 // 2   // 10
 *                                                                                               // 3   // 11
 * Copyright 2011 - 2013 appendTo LLC. (http://appendto.com/team)                                // 4   // 12
 * Dual licensed under the MIT or GPL licenses.                                                  // 5   // 13
 * http://appendto.com/open-source-licenses                                                      // 6   // 14
 *                                                                                               // 7   // 15
 * http://amplifyjs.com                                                                          // 8   // 16
 */                                                                                              // 9   // 17
(function( global, undefined ) {                                                                 // 10  // 18
                                                                                                 // 11  // 19
var slice = [].slice,                                                                            // 12  // 20
	subscriptions = {};                                                                             // 13  // 21
                                                                                                 // 14  // 22
var amplify = global.amplify = {                                                                 // 15  // 23
	publish: function( topic ) {                                                                    // 16  // 24
		if ( typeof topic !== "string" ) {                                                             // 17  // 25
			throw new Error( "You must provide a valid topic to publish." );                              // 18  // 26
		}                                                                                              // 19  // 27
                                                                                                 // 20  // 28
		var args = slice.call( arguments, 1 ),                                                         // 21  // 29
			topicSubscriptions,                                                                           // 22  // 30
			subscription,                                                                                 // 23  // 31
			length,                                                                                       // 24  // 32
			i = 0,                                                                                        // 25  // 33
			ret;                                                                                          // 26  // 34
                                                                                                 // 27  // 35
		if ( !subscriptions[ topic ] ) {                                                               // 28  // 36
			return true;                                                                                  // 29  // 37
		}                                                                                              // 30  // 38
                                                                                                 // 31  // 39
		topicSubscriptions = subscriptions[ topic ].slice();                                           // 32  // 40
		for ( length = topicSubscriptions.length; i < length; i++ ) {                                  // 33  // 41
			subscription = topicSubscriptions[ i ];                                                       // 34  // 42
			ret = subscription.callback.apply( subscription.context, args );                              // 35  // 43
			if ( ret === false ) {                                                                        // 36  // 44
				break;                                                                                       // 37  // 45
			}                                                                                             // 38  // 46
		}                                                                                              // 39  // 47
		return ret !== false;                                                                          // 40  // 48
	},                                                                                              // 41  // 49
                                                                                                 // 42  // 50
	subscribe: function( topic, context, callback, priority ) {                                     // 43  // 51
		if ( typeof topic !== "string" ) {                                                             // 44  // 52
			throw new Error( "You must provide a valid topic to create a subscription." );                // 45  // 53
		}                                                                                              // 46  // 54
                                                                                                 // 47  // 55
		if ( arguments.length === 3 && typeof callback === "number" ) {                                // 48  // 56
			priority = callback;                                                                          // 49  // 57
			callback = context;                                                                           // 50  // 58
			context = null;                                                                               // 51  // 59
		}                                                                                              // 52  // 60
		if ( arguments.length === 2 ) {                                                                // 53  // 61
			callback = context;                                                                           // 54  // 62
			context = null;                                                                               // 55  // 63
		}                                                                                              // 56  // 64
		priority = priority || 10;                                                                     // 57  // 65
                                                                                                 // 58  // 66
		var topicIndex = 0,                                                                            // 59  // 67
			topics = topic.split( /\s/ ),                                                                 // 60  // 68
			topicLength = topics.length,                                                                  // 61  // 69
			added;                                                                                        // 62  // 70
		for ( ; topicIndex < topicLength; topicIndex++ ) {                                             // 63  // 71
			topic = topics[ topicIndex ];                                                                 // 64  // 72
			added = false;                                                                                // 65  // 73
			if ( !subscriptions[ topic ] ) {                                                              // 66  // 74
				subscriptions[ topic ] = [];                                                                 // 67  // 75
			}                                                                                             // 68  // 76
                                                                                                 // 69  // 77
			var i = subscriptions[ topic ].length - 1,                                                    // 70  // 78
				subscriptionInfo = {                                                                         // 71  // 79
					callback: callback,                                                                         // 72  // 80
					context: context,                                                                           // 73  // 81
					priority: priority                                                                          // 74  // 82
				};                                                                                           // 75  // 83
                                                                                                 // 76  // 84
			for ( ; i >= 0; i-- ) {                                                                       // 77  // 85
				if ( subscriptions[ topic ][ i ].priority <= priority ) {                                    // 78  // 86
					subscriptions[ topic ].splice( i + 1, 0, subscriptionInfo );                                // 79  // 87
					added = true;                                                                               // 80  // 88
					break;                                                                                      // 81  // 89
				}                                                                                            // 82  // 90
			}                                                                                             // 83  // 91
                                                                                                 // 84  // 92
			if ( !added ) {                                                                               // 85  // 93
				subscriptions[ topic ].unshift( subscriptionInfo );                                          // 86  // 94
			}                                                                                             // 87  // 95
		}                                                                                              // 88  // 96
                                                                                                 // 89  // 97
		return callback;                                                                               // 90  // 98
	},                                                                                              // 91  // 99
                                                                                                 // 92  // 100
	unsubscribe: function( topic, context, callback ) {                                             // 93  // 101
		if ( typeof topic !== "string" ) {                                                             // 94  // 102
			throw new Error( "You must provide a valid topic to remove a subscription." );                // 95  // 103
		}                                                                                              // 96  // 104
                                                                                                 // 97  // 105
		if ( arguments.length === 2 ) {                                                                // 98  // 106
			callback = context;                                                                           // 99  // 107
			context = null;                                                                               // 100
		}                                                                                              // 101
                                                                                                 // 102
